...
M1.3 prerequisite-route and write-set freeze; it authorizes no Skill/Shell/Package/test change,
candidate, install, credential, Provider call, or WorkBuddy action. The
